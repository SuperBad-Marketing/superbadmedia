 ...
 *
 * Same v2 visual treatment as the admin RevealClient (scroll-triggered
 * alternating bands, structured insights, collapsed portrait), but without
 * NextAuth SessionProvider (portal uses cookie auth, not JWT).
 *
 * Calls `markPortalProfileComplete` instead of admin `markProfileComplete`.
 * Optionally shows a retake comparison narrative below the portrait.
 *
 * Owner: BDA-5.
 */
                ...
                <Reveal key={i} delay={0.05 + i * 0.05}>
                  <p
                    style={{
                      ...
                      opacity: 0.8,
                      marginBottom:
                        i < previewParagraphs.length - 1 ? 20 : 0,
                    }}
                  >
                    {i === 0 ? (
                      <>
...
// ── Parsers (same as admin RevealClient, backward-compatible) ─────────
