...
export default function StoryboardView() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      <div className="h-20 shrink-0 px-8 pt-3.5 pb-2.5 flex flex-col gap-2">
        {selectedTrack ? (
          <>
      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden border-y border-border">
        <div className="flex items-center gap-0 px-8 py-5 min-h-full">
          <DndContext
            sensors={sensors}
      ...
      <div className="h-14 shrink-0 px-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
